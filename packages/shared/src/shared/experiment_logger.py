...
def log_experiment(
    ...
    Args:
        ...
        tool_name: Optional tool name to include in filename (e.g., 'bolt', 'lovable')
    ...
    Examples:
        # Vibetester pipeline with transcript, URL, and tool
        log_experiment(
            data=result, 
        ...
        # Output: 20251128_130649_vibetester_multiplayer_game_bolt_example.json
    ...
    if tool_name:
        filename_parts.append(_sanitize_for_filename(tool_name))
